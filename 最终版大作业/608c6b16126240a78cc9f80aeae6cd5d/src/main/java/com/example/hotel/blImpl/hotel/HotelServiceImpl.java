...
public class HotelServiceImpl implements HotelService {
    ...
    public void updateRoomInfo(Integer hotelId, String roomType ,double price, Integer rooms) {
        roomService.updateRoomInfo(hotelId,roomType,price,rooms);
    }
    ...
    @Override
    public List<HotelVO> findHotelInfo(HotelForm hotelForm) {

       return hotelMapper.selectHotelInfo(hotelForm);
    }
